                ...
                $nor: [{
                    ...
                    "contacts.questions.answers": {
                        $elemMatch: {
                            ...
                            "loopInstances": {$elemMatch: {is_selected: true, $or: [{loop_instance: 50}, {loop_text: "ADP"},]}}   
                        }   
                    }
                }]
            }   
            ...
            $match: {
                $or: [
                    ...
                    {"contacts.questions.answers.loopInstances.loop_text": "ADP"},
                    {
                        ...
                        $or: [{"contacts.win_vendor.value":50}, {"contacts.win_vendor.name": "ADP"}]
                    }
                ]
            }
        },
